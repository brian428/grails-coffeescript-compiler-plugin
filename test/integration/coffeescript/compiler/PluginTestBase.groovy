...
abstract class PluginTestBase
{
	...
	void testDefaultConfig( )
	{
		...
		assertTrue( "Compiled file ${ jsFile.path } does not contain expected JavaScript", jsFile.text.contains( 'someFunctionCall' ) )
	}
	...
	void testCompileFile( )
	{
		...
		assertTrue( "Generated file ${ jsFile.path } does not exist", jsFile.exists() )
		assertTrue( "Compiled file does not contain expected JavaScript", jsFile.text.contains( 'someFunctionCall' ) )
	}
